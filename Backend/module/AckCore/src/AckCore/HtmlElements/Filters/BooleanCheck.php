        ...
        <div class="filterElement">
            <fieldset class="field checkboxGruop">
                 <label class="placeholder">
                        <input type="checkbox" autocomplete="off" radio="visivel" class="placeholder-check" <?php $this->composeSelection(1) ?> name="<?php echo $this->getName() ?>_true" value="<?php echo ($value === $this->getDefaultValue()) ? 1 : 0; ?>" />
                        <p class="field-text">Sim</p>
                        <label class="placeholder">
                        <input type="checkbox" autocomplete="off" radio="visivel" class="placeholder-check" <?php $this->composeSelection(0) ?> name="<?php echo $this->getName() ?>_false" value="<?php echo ($value === $this->getDefaultValue()) ? 1 : 0; ?>" />
