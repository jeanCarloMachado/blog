<?php
/**
 * gerenciamento NotificacoesController
 *
 * AckDefault - Cub
 *
...
{
    protected $models = array('default'=>'\AckContact\Model\Notificacoes');
    ...
    public function minhasnotificacoesAction()
    {
        ...
        $vars['notificacoes'] = $this->getModelInstance()->onlyAvailable()->toObject()->getFromUser($auth->getIdentity());
