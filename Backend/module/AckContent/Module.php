...
class Module implements AutoloaderProviderInterface
{
    ...
    public function getServiceConfig()
    {
        return array(
            'factories'  => array(
                'notify' => function ($sm) {
                    $helper = \AckContent\View\Helper\NotificationBlock::getInstance();
    ...
    public function getViewHelperConfig()
    {
        return array(
        'factories' => array(
            'notificationBlock' => function ($sm) {
                $helper = \AckContent\View\Helper\NotificationBlock::getInstance();

                return $helper;
            },

            'PolishedBoot' => function ($sm) {
                $helper = new \AckContent\View\Helper\PolishedBoot;
