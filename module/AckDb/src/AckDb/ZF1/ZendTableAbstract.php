 ...
 */
require_once __DIR__."/ZF1/Db/Adapter/Abstract.php";
require_once __DIR__."/ZF1/Db/Select.php";
require_once __DIR__."/ZF1/Db.php";
require_once __DIR__."/ZF1/Db/Table/Abstract.php";

///###################################################################################
//################################# db table abstract sobreescrita###########################################
//###################################################################################
abstract class ZendTableAbstract extends \Zend_Db_Table_Abstract
{
     ...
     * @return Zend_Db_Table_Abstract Provides a fluent interface
     */
    public function setRowName($name)
    {
        $this->_row = (string) $name;
    ...
    protected function _setupPrimaryKey()
    {
        if (!$this->_primary) {
            ...
            if (empty($this->_primary)) {
                require_once __DIR__."/ZF1/Db/Table/Exception.php";
    ...
    {
        require_once __DIR__.'/ZF1/Db/Table/Select.php';
...
//###################################################################################
//################################# END db table abstract sobreescrita########################################
//###################################################################################
