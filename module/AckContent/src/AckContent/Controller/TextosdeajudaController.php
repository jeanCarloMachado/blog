<?php
/**
 * gerenciamento TextosdeajudaController
 *
 * AckDefault - Cub
 *
 ...
 * @link     http://github.com/zendframework/zf2 for the canonical source repository
 */
class TextosdeajudaController extends Controller
{
    protected $models = array('default'=>'\AckContent\Model\Ajudas');

    protected $title = 'Textosdeajuda';
    ...
    {
        $vars = array();
        $modelAjudaCategorias = new \AckContent\Model\AjudaCategorias;
        $vars["AjudaCategorias"] = $modelAjudaCategorias->toObject()->onlyAvailable()->get();
